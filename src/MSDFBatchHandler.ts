...
const SimpleVertexShader = [
    ...
    'attribute vec4 inParams;',   // weight, rounded, width (a shadow's spread), softness — or, on a solid quad, weight=255, radius, border, blur. See MSDFColor.
    '',
