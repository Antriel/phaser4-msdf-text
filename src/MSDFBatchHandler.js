...
const SimpleFragmentShader = [
    ...
    '    {',
    '        // Single coverage from the outline outer edge; the colour is mixed',
    '        // between outline and text. This avoids the alpha dip that compositing',
    '        // two independent alphas would create across the text/outline AA band',
    '        // (visible as a darker ring when text and outline share a colour).',
    '        float textEdge = 0.5;',
