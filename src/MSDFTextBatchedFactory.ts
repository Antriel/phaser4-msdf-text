 ...
 *
 * This registers the `msdfTextBatched` method on the GameObjectFactory,
 * making it available as `scene.add.msdfTextBatched(x, y, font, text, fontSize)`
 */
 ...
 *
 * @method Phaser.GameObjects.GameObjectFactory#msdfTextBatched
 *
 ...
 */
GameObjectFactory.register('msdfTextBatched', function (
    x: number,
    y: number,
    font: MSDFFont,
    text: string = '',
